---
title: "Beginner's Guide to nflfastR"
author: "Ben Baldwin (learnr by Tan Ho)"
date: "20/06/2020"
output: 
  learnr::tutorial:
        css: css/styles.css
...
```{r fig1, warning = FALSE, message = FALSE, results = 'hide', fig.keep = 'all'}
...
```{r fig2, warning = FALSE, message = FALSE, results = 'hide', fig.keep = 'all'}
qbs %>%
...
```{r fig3, warning = FALSE, message = FALSE, results = 'hide', fig.keep = 'all'}
qbs %>%
  ggplot(aes(x = cpoe, y = epa)) +
  #horizontal line with mean EPA
  geom_hline(yintercept = mean(qbs$epa), color = "red", linetype = "dashed", alpha=0.5) +
